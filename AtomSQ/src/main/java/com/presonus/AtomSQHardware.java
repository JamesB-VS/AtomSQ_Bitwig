...
public class AtomSQHardware
{
     ...
     */
    public AtomSQHardware (final MidiOut outputPort, final MidiIn inputPort, final ShortMidiDataReceivedCallback inputCallback, final SettableEnumValue fixVelocityEnableSetting, final SettableRangedValue fixVelocityValueSetting)
    {
